ETHER_TYPES = {
    ...
    '0814': 'SNMP',
    '880b': 'PPP',
    '88c7': 'Autenticación 802.11 wifi',
}
...
def process_list(frame) -> dict:
    return {
        ...
        'Red': {
            ...
            'Puerto Origen': convert_hex_to_decimal(''.join(frame[34:36])),
            'Puerto Destino': convert_hex_to_decimal(''.join(frame[36:38])),
        },
        'Adicional': {
            'Puerto Origen': get_detailed_description(PUERTOS_ESPECIALES.get(convert_hex_to_decimal(''.join(frame[34:36]))), 'Puerto Origen'),
            'Puerto Destino': get_detailed_description(PUERTOS_ESPECIALES.get(convert_hex_to_decimal(''.join(frame[36:38]))), 'Puerto Destino'),
        }
    }